...
# Unit tests for OsunyApi::CommunicationWebsiteAgendaEventLocalization
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommunicationWebsiteAgendaEventLocalization' do
  before do
    # run before each test
    @instance = OsunyApi::CommunicationWebsiteAgendaEventLocalization.new
  end
  ...
  describe 'test an instance of CommunicationWebsiteAgendaEventLocalization' do
    it 'should create an instance of CommunicationWebsiteAgendaEventLocalization' do
      expect(@instance).to be_instance_of(OsunyApi::CommunicationWebsiteAgendaEventLocalization)
    end
  end
