...
# Unit tests for OsunyApi::CommunicationBlockImage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommunicationBlockImage' do
  before do
    # run before each test
    @instance = OsunyApi::CommunicationBlockImage.new
  end
  ...
  describe 'test an instance of CommunicationBlockImage' do
    it 'should create an instance of CommunicationBlockImage' do
      expect(@instance).to be_instance_of(OsunyApi::CommunicationBlockImage)
    end
  end
