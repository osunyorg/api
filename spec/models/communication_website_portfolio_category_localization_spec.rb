...
# Unit tests for OsunyApi::CommunicationWebsitePortfolioCategoryLocalization
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CommunicationWebsitePortfolioCategoryLocalization' do
  before do
    # run before each test
    @instance = OsunyApi::CommunicationWebsitePortfolioCategoryLocalization.new
  end
  ...
  describe 'test an instance of CommunicationWebsitePortfolioCategoryLocalization' do
    it 'should create an instance of CommunicationWebsitePortfolioCategoryLocalization' do
      expect(@instance).to be_instance_of(OsunyApi::CommunicationWebsitePortfolioCategoryLocalization)
    end
  end
