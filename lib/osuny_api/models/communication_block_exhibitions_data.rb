...
module OsunyApi
  ...
  class CommunicationBlockExhibitionsData
    ...
    attr_accessor :no_exhibition_message
    ...
    def self.attribute_map
      {
        ...
        :'quantity' => :'quantity',
        :'time' => :'time',
        :'no_exhibition_message' => :'no_exhibition_message',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OsunyApi::CommunicationBlockExhibitionsData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OsunyApi::CommunicationBlockExhibitionsData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'no_exhibition_message')
        self.no_exhibition_message = attributes[:'no_exhibition_message']
      end
    ...
    def time=(time)
      validator = EnumAttributeValidator.new('Object', ['current', 'future_or_current', 'future', 'archive'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          quantity == o.quantity &&
          time == o.time &&
          no_exhibition_message == o.no_exhibition_message &&
    ...
    def hash
      [layout, mode, category_id, description, quantity, time, no_exhibition_message, option_categories, option_dates, option_image, option_subtitle, option_summary, option_status, elements].hash
    end
