...
module OsunyApi
  ...
  class CommunicationBlockPagesData
    ...
    attr_accessor :option_main_summary
    ...
    def self.attribute_map
      {
        ...
        :'option_main_summary' => :'option_main_summary',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OsunyApi::CommunicationBlockPagesData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OsunyApi::CommunicationBlockPagesData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'option_main_summary')
        self.option_main_summary = attributes[:'option_main_summary']
      end
    ...
    def valid?
      ...
      mode_validator = EnumAttributeValidator.new('Object', ['selection', 'children', 'category'])
    ...
    def mode=(mode)
      validator = EnumAttributeValidator.new('Object', ['selection', 'children', 'category'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          option_main_summary == o.option_main_summary &&
    ...
    def hash
      [layout, mode, text, page_id, category_id, option_image, option_categories, option_main_summary, option_summary, elements].hash
    end
