...
module OsunyApi
  ...
  class CommunicationBlockJobsData
    attr_accessor :layout

    attr_accessor :mode

    attr_accessor :jobs_quantity

    attr_accessor :category_id

    attr_accessor :description

    attr_accessor :no_job_message
    ...
    def self.openapi_types
      {
        :'layout' => :'Object',
        :'mode' => :'Object',
        :'jobs_quantity' => :'Object',
        :'category_id' => :'Object',
        :'description' => :'Object',
        :'no_job_message' => :'Object',
        :'option_image' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OsunyApi::CommunicationBlockJobsData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OsunyApi::CommunicationBlockJobsData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'jobs_quantity')
        self.jobs_quantity = attributes[:'jobs_quantity']
      end
      ...
      if attributes.key?(:'no_job_message')
        self.no_job_message = attributes[:'no_job_message']
      end
    ...
    def valid?
      layout_validator = EnumAttributeValidator.new('Object', ['grid', 'list'])
    ...
    def layout=(layout)
      validator = EnumAttributeValidator.new('Object', ['grid', 'list'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          layout == o.layout &&
          mode == o.mode &&
          jobs_quantity == o.jobs_quantity &&
          category_id == o.category_id &&
          description == o.description &&
          no_job_message == o.no_job_message &&
    ...
    def hash
      [layout, mode, jobs_quantity, category_id, description, no_job_message, option_image, option_subtitle, option_categories, option_date, option_summary, elements].hash
    end
