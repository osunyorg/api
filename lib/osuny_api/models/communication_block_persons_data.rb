...
module OsunyApi
  ...
  class CommunicationBlockPersonsData
    ...
    attr_accessor :alphabetical

    attr_accessor :option_image

    attr_accessor :option_summary

    attr_accessor :option_link

    attr_accessor :option_contact
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OsunyApi::CommunicationBlockPersonsData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OsunyApi::CommunicationBlockPersonsData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'option_contact')
        self.option_contact = attributes[:'option_contact']
      end
    ...
    def mode=(mode)
      validator = EnumAttributeValidator.new('Object', ['selection', 'category'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          option_contact == o.option_contact &&
          elements == o.elements
    end
    ...
    def hash
      [layout, mode, category_id, description, alphabetical, option_image, option_summary, option_link, option_contact, elements].hash
    end
