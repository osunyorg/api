...
module OsunyApi
  ...
  class CommunicationBlockOrganizationsData
    ...
    def valid?
      layout_validator = EnumAttributeValidator.new('Object', ['grid', 'map'])
    ...
    def layout=(layout)
      validator = EnumAttributeValidator.new('Object', ['grid', 'map'])
    ...
    def hash
      [layout, mode, category_id, description, alphabetical, option_link, option_logo, option_summary, elements].hash
    end
