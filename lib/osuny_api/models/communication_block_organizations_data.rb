...
module OsunyApi
  ...
  class CommunicationBlockOrganizationsData
    ...
    attr_accessor :option_logo

    attr_accessor :option_summary

    attr_accessor :option_address

    attr_accessor :option_filters
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'option_logo')
        self.option_logo = attributes[:'option_logo']
      end
    ...
    def layout=(layout)
      validator = EnumAttributeValidator.new('Object', ['grid', 'large', 'map', 'carousel'])
    ...
    def hash
      [layout, mode, category_id, description, alphabetical, option_link, option_logo, option_summary, option_address, option_filters, elements].hash
    end
