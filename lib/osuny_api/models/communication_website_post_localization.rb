...
module OsunyApi
  class CommunicationWebsitePostLocalization
    ...
    def hash
      [id, migration_identifier, title, featured_image, meta_description, pinned, published, published_at, slug, subtitle, summary, text, blocks, created_at, updated_at].hash
    end
