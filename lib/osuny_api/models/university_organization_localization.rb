...
module OsunyApi
  class UniversityOrganizationLocalization
    attr_accessor :id
    ...
    attr_accessor :address_additional
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OsunyApi::UniversityOrganizationLocalization` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OsunyApi::UniversityOrganizationLocalization`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'address_additional')
        self.address_additional = attributes[:'address_additional']
      end
      ...
      if attributes.key?(:'mastodon')
        self.mastodon = attributes[:'mastodon']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          address_additional == o.address_additional &&
          linkedin == o.linkedin &&
          mastodon == o.mastodon &&
          twitter == o.twitter &&
          url == o.url &&
    ...
    def hash
      [id, migration_identifier, name, long_name, featured_image, meta_description, published, published_at, address_name, address_additional, linkedin, mastodon, twitter, url, slug, summary, text, blocks, created_at, updated_at].hash
    end
