...
module OsunyApi
  class UniversityOrganizationLocalization
    ...
    def hash
      [id, migration_identifier, name, long_name, featured_image, meta_description, address_name, address_additional, linkedin, mastodon, twitter, url, slug, summary, text, blocks, created_at, updated_at].hash
    end
