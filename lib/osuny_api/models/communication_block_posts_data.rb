...
module OsunyApi
  ...
  class CommunicationBlockPostsData
    attr_accessor :layout

    attr_accessor :mode

    attr_accessor :posts_quantity

    attr_accessor :category_id

    attr_accessor :option_author

    attr_accessor :option_categories

    attr_accessor :option_date

    attr_accessor :option_image

    attr_accessor :option_reading_time
    ...
    def self.attribute_map
      {
        ...
        :'option_reading_time' => :'option_reading_time',
    ...
    def self.openapi_types
      {
        :'layout' => :'Object',
        :'mode' => :'Object',
        :'posts_quantity' => :'Object',
        :'category_id' => :'Object',
        :'option_author' => :'Object',
        :'option_categories' => :'Object',
        :'option_date' => :'Object',
        :'option_image' => :'Object',
        :'option_reading_time' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OsunyApi::CommunicationBlockPostsData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OsunyApi::CommunicationBlockPostsData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'posts_quantity')
        self.posts_quantity = attributes[:'posts_quantity']
      end
      ...
      if attributes.key?(:'option_author')
        self.option_author = attributes[:'option_author']
      end
      ...
      if attributes.key?(:'option_date')
        self.option_date = attributes[:'option_date']
      end
      ...
      if attributes.key?(:'option_reading_time')
        self.option_reading_time = attributes[:'option_reading_time']
      end
    ...
    def valid?
      layout_validator = EnumAttributeValidator.new('Object', ['grid', 'list', 'highlight', 'alternate', 'large', 'carousel'])
    ...
    def layout=(layout)
      validator = EnumAttributeValidator.new('Object', ['grid', 'list', 'highlight', 'alternate', 'large', 'carousel'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          layout == o.layout &&
          mode == o.mode &&
          posts_quantity == o.posts_quantity &&
          category_id == o.category_id &&
          option_author == o.option_author &&
          option_categories == o.option_categories &&
          option_date == o.option_date &&
          option_image == o.option_image &&
          option_reading_time == o.option_reading_time &&
    ...
    def hash
      [layout, mode, posts_quantity, category_id, option_author, option_categories, option_date, option_image, option_reading_time, option_subtitle, option_summary, elements].hash
    end
